...
%     PowDip=zeros(size(layer));
%     PowDip(input(dermi,1:2))=1;
%     figure;scatter3pnt(pnt,25,PowDip)
%     FIXME dipole orientation
%     M=gain(:,pnti);
%     M=sum(M')';
